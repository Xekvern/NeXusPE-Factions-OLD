...
class SpongeLauncher extends CustomItem {
    ...
    /**
     * SpongeLauncher constructor.
     *
     * @param int $tier
     * @param int $uses
     */
    public function __construct(int $tier, int $uses, string $type, string $range) {
        $customName = TextFormat::RESET . TextFormat::YELLOW . TextFormat::BOLD . "Sponge Launcher";
        $lore = [];
        $lore[] = "";
        $lore[] = TextFormat::RESET . TextFormat::YELLOW . "The greater the tier, the larger the sponge-ball!";
        $lore[] = "";
        ...
        $lore[] = "";
        $lore[] = TextFormat::RESET . TextFormat::GRAY . "Each fire will require " . TextFormat::YELLOW . ItemHandler::getSpongeFuelAmountByTier($tier) . TextFormat::GRAY . " blocks of Sponge";
        parent::__construct(VanillaItems::BAMBOO(), $customName, $lore, [],
        [
